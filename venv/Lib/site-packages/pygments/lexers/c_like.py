...
class ArduinoLexer(CppLexer):
    ...
    variables = set((
        ...
        # Picuino panel PC42
        'KEY_PRESSED_TIME1', 'KEY_PRESSED_TIME2', 'KEY_PRESSED_TIME3', 'KEY_RELEASED', 
        'KEY_ALL', 'KEY_LEFT', 'KEY_RIGHT', 'KEY_UP', 'KEY_DOWN', 'KEY_ENTER', 
        'KEY_BACK', 'LED_ON', 'LED_OFF', 'DD_0', 'DD_1', 'DD_2', 'DD_3', 'DD_4', 
        'DD_5', 'DD_6', 'DD_7', 'DD_8', 'DD_9', 'DD_A', 'DD_b', 'DD_B', 'DD_C', 
        'DD_d', 'DD_E', 'DD_F', 'DD_G', 'DD_g', 'DD_H', 'DD_h', 'DD_I', 'DD_i', 
        'DD_J', 'DD_K', 'DD_L', 'DD_n', 'DD_ny', 'DD_o', 'DD_O', 'DD_P', 'DD_q', 
        'DD_r', 'DD_S', 'DD_t', 'DD_u', 'DD_U', 'DD_y', 'DD_Y', 'DD_Z', 'DD_SP', 
        'Silence', 'Do0', 'Do_0', 'Re0', 'Re_0', 'Mi0', 'Fa0', 'Fa_0', 'Sol0', 
        'Sol_0', 'La0', 'La_0', 'Si0', 'Do1', 'Do_1', 'Re1', 'Re_1', 'Mi1', 'Fa1', 
        'Fa_1', 'Sol1', 'Sol_1', 'La1', 'La_1', 'Si1', 'Do2', 'Do_2', 'Re2', 'Re_2', 
        'Mi2', 'Fa2', 'Fa_2', 'Sol2', 'Sol_2', 'La2', 'La_2', 'Si2', 'Do3', 'Do_3', 
        'Re3', 'Re_3', 'Mi3', 'Fa3', 'Fa_3', 'Sol3', 'Sol_3', 'La3', 'La_3', 'Si3', 
        'Do4', 'Do_4', 'Re4', 'Re_4', 'Mi4', 'Fa4', 'Fa_4', 'Sol4', 'Sol_4', 'La4', 
        'La_4', 'Si4', 'Do5', 'Do_5', 'Re5', 'Re_5', 'Mi5', 'Fa5', 'Fa_5', 'Sol5', 
        'Sol_5', 'La5', 'La_5', 'Si5', 'Do6', 'Do_6', 'Re6', 'Re_6', 'Mi6', 'Fa6', 
        'Fa_6', 'Sol6', 'Sol_6', 'La6', 'La_6', 'Si6', 'Do7', 'Do_7', 'Re7', 'Re_7', 
        'Mi7', 'Fa7', 'Fa_7', 'Sol7', 'Sol_7', 'La7', 'La_7', 'Si7', 'Do8', 'Do_8', 
        'Re8', 'Re_8', 'Mi8', 'Fa8', 'Fa_8', 'Sol8', 'Sol_8', 'La8', 'La_8', 'Si8', 
        'Do9', 'Do_9', 'Re9', 'Re_9', 'Mi9', 'Fa9', 'Fa_9', 'Sol9', 'Sol_9', 'La9', 
        'La_9', 'Si9', 'Do10', 'Do_10', 'Re10', 'Re_10', 'Mi10', 'Fa10', 'Fa_10', 
        'Sol10', 'Sol_10', 'La10', 'La_10', 'Si10', 
        'EEPROM_MAX_ADDR', 'EADDR_TWI_ADDRESS', 'EADDR_OSCCAL', 'EADDR_TEMP_OFFSET', 
        'EADDR_TEMP_GAIN', 'EADDR_VREF_OFFSET',
        ))
    ...
    functions = set((
        ...
        # Picuino panel PC42
        'begin', 'sysBegin', 'sysVersion', 'analogRead', 'eepromWrite', 'eepromRead', 
        'sysOsccal', 'sysTest', 'ledBegin', 'ledWrite', 'ledBlink', 'ledBright', 
        'keyBegin', 'keyValue', 'keyPressed', 'keyToggle', 'keyTimeOn', 'keyTimeOff', 
        'keyCount', 'keyEvents', 'keyReset', 'dispBegin', 'dispNum', 'dispWrite', 
        'dispDots', 'buzzBegin', 'buzzOn', 'buzzOff', 'buzzFreq', 'buzzTone', 
        'buzzPlay', 'PC42', 'pc',
        ))
