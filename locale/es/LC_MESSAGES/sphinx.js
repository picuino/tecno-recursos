...
"plural_expr": "(n != 1)",
"messages": {"Next topic": "Pr\u00f3ximo tema",
"Index": "\u00cdndice",
"%(filename)s &mdash; %(docstitle)s": "%(filename)s &mdash; %(docstitle)s",
...
"&copy; Copyright %(copyright)s.": "&copy; Copyright %(copyright)s.",
"Global Module Index": "\u00cdndice Global de M\u00f3dulos",
"Your search did not match any documents. Please make sure that all words are spelled correctly and that you've selected enough categories.": "Su b\u00fasqueda no coincide con ning\u00fan documento. Por favor, aseg\u00farese de que todas las palabras est\u00e9n correctamente escritas y de que usted haya seleccionado las suficientes categor\u00edas.",
...
"Changes in Version %(version)s &mdash; %(docstitle)s": "Cambios en la versi\u00f3n %(version)s &mdash; %(docstitle)s",
...
"From here you can search these documents. Enter your search\n    words into the box below and click \"search\". Note that the search\n    function will automatically search for all of the words. Pages\n    containing fewer words won't appear in the result list.": "Este es el di\u00e1logo de b\u00fasqueda.  Introduzca los t\u00e9rminos en el\n    di\u00e1logo siguiente y pulse \"buscar\". Tenga en cuenta que el asistente buscar\u00e1 \n    autom\u00e1ticamente todas las palabras. Las p\u00e1ginas que contengan \n    menos palabras no aparecer\u00e1n en la lista de resultados.",
...
"last updated": "actualizado por \u00faltima vez en",
...
"Enter search terms or a module, class or function name.": "Introduzca los t\u00e9rminos de b\u00fasqueda o un nombre de m\u00f3dulo, clase o funci\u00f3n.",
"&copy; <a href=\"%(path)s\">Copyright</a> %(copyright)s.": "&copy; <a href=\\\"%(path)s\\\">Copyright</a> %(copyright)s.",
