...
.. _writer-formato-caracter-1:

Formato de carácter I
=====================
...
#. Al abrir el archivo anterior nos encontraremos con el 
   ...
   .. image:: writer/_images/writer-p08-ejercicio.png
              :align: center
              :alt: Ejercicio formato de carácter I.
...
#. Para dar el formato necesario al texto vamos a utilizar
   ...
   .. image:: writer/_images/writer-p08-barra-herramientas.png
              :align: center
   ...
   El botón |button-superindice| cambia el formato a superíndice

   El botón |button-subindice| cambia el formato a subíndice

   El botón |button-color-texto| cambia el color del texto
