...
#. A continuación escribiremos las siguientes frases en el programa 
   ...
   .. image:: writer/_images/writer-ejercicio-teclado-3.png
              :alt: Ejercicio 3
              :align: center
...
#. **MAYÚSCULAS**
   ...
   Para escribir mucho texto en mayúsculas se utiliza la tecla 
   de bloqueo de mayúsculas |tecla-bloq-mayus|
   
   Al pulsar la tecla, el teclado escribe **todo en mayúsculas**. 
   Al volver a pulsar la tecla el teclado escribe todo en minúsculas.

   |br|

   Para escribir **una sola letra en mayúsculas** se utiliza la tecla 
   de mayúsculas o también llamada tecla de shift |tecla-shift|.
   
   Si el teclado está en modo de mayúsculas, al pulsar la tecla shift
