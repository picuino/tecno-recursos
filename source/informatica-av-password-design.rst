...
#. Ahora vamos a unir las palabras para formar una frase larga, sin 
...
#. La palabra resultante debe tener bastantes letras para que sea segura,
   lo ideal es que supere las 10 letras.
   Nuestra palabra de ejemplo tiene un total de 19 letras, que es
   suficiente.

   |br|

#. Por último vamos a añadir un **número y un símbolo** que te gusten.
   ...
   Contraseña de ejemplo: **GatoLunaPizzaCohete#4**

   |br|

#. Ya tenemos nuestra contraseña creada. Recuerda que debes crear 
   una contraseña segura para cada servicio que uses en Internet.
   
   Puedes hacer variaciones de la contraseña añadiendo más
   información al final de la misma, para diferenciarla dependiendo del
   servicio que vayas a usar.
   
   Contraseña de Instagram de ejemplo: **GatoLunaPizzaCohete#4IG**
   
   Contraseña de YouTube de ejemplo: **GatoLunaPizzaCohete#4YT**
...
#. Ahora es necesario memorizar la contraseña para que no tengamos que 
   ...
   La historia podría quedar así: Un **gato** va a la **luna** y se come
   una **pizza** dentro del **cohete** espacial mientras grita **cuatro**
