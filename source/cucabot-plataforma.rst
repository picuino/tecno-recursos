...
.. figure:: cucabot/_images/cucabot-plataforma-planta.png
   :alt: Planta de la plataforma universal para construir los robots Cucabot.
   :width: 680px
   :align: center
   
   Planta de la plataforma universal para construir los robots Cucabot.

.. figure:: cucabot/_images/cucabot-plataforma-perfil.png
   :alt: Perfil de la plataforma universal para construir los robots Cucabot.
   :width: 600px
   :align: center
...
.. figure:: cucabot/_images/cucabot-plataforma-schema.png
   :alt: Esquema eléctrico de la plataforma universal Cucabot.
   :width: 680px
   :align: center
   
   Esquema eléctrico de la plataforma universal Cucabot.

.. figure:: cucabot/_images/cucabot-plataforma-cableado.png
   :alt: Esquema de cableado de la plataforma universal Cucabot.
   :width: 600px
   :align: center
