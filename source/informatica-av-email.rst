...
#. Dentro de la web de EducaMadrid, seleccionamos el icono
   **"Correo"**:
   ...
   .. image:: informatica/_images/informatica-av-correo-icono.png
      :align: center
      :alt: Icono de correo web de EducaMadrid.
   ...
   .. image:: informatica/_images/informatica-av-acceder-email.png
      :align: center
      :alt: Ventana para acceder al correo electrónico de EducaMadrid.

   |br|

   Estos pasos nos llevarán a la
   `página de inicio del correo web de EducaMadrid
   <https://correoweb.educa.madrid.org/>`__: correoweb.educa.madrid.org
...
#. Una vez que entremos en el correo electrónico nos encontraremos en la
