...
.. glossary::
   ...
   Fuente de alimentación
      ...
      adaptadores se están diseñando para dar una potencia cada vez mayor,
      por lo que no es extraño encontrar adaptadores de 20W hasta 80W o más,
      cuando anteriormente los cargadores USB raramente tenían más de 10W.
   ...
   Refrigeración por aire
      ...
      se utiliza en los ordenadores más potentes (por ejemplo un PC),
      para extraer fuera de la caja el calor generado por sus circuitos.
   ...
   Reloj en tiempo real
      ...
      la hora actual aunque el ordenador se encuentre apagado.
      Normalmente van acompañados de una pequeña pila de tipo botón para
      darles alimentación. Su consumo es muy reducido, por lo que la pila
