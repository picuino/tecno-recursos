...
#. Ahora añadiremos el programa de la **Barra**.
   ...
   .. image:: scratch/_images/scratch-p07-prog1.png
      :width: 470px
...
#. A continuación añadiremos el programa de la **Pelota**.
   ...
   .. image:: scratch/_images/scratch-p07-prog2.png
      :width: 512px

   .. image:: scratch/_images/scratch-p07-prog5.png
      :width: 501px
...
#. Por último añadiremos el programa del **Ladrillo**.
   ...
   .. image:: scratch/_images/scratch-p07-prog3.png
      :width: 422px

   .. image:: scratch/_images/scratch-p07-prog4.png
      :width: 482px
