...
.. glossary::
   ...
   `Apropiación de formulario <https://es.wikipedia.org/wiki/Apropiaci%C3%B3n_de_formulario>`__
      La "apropiación de formulario" es una táctica utilizada por
   ...
   `Ataque de abrevadero <https://es.wikipedia.org/wiki/Ataque_de_abrevadero>`__
      El "ataque de abrevadero" es una estrategia de ciberataque en la
   ...
   `Ataque de día cero <https://es.wikipedia.org/wiki/Ataque_de_d%C3%ADa_cero>`__
      El "ataque de día cero" es una técnica de ciberataque que explota
   ...
   `Ataque de fuerza bruta <https://es.wikipedia.org/wiki/Ataque_de_fuerza_bruta>`__
      Un "ataque de fuerza bruta" es una técnica utilizada por los
   ...
   `Ataque man-in-the-middle <https://es.wikipedia.org/wiki/Ataque_de_intermediario>`__
      El "ataque man-in-the-middle" es una técnica de ciberataque en la
   ...
   `Botnet <https://es.wikipedia.org/wiki/Botnet>`__
      Una "botnet" es una red de dispositivos infectados por software
   ...
   `Brecha de seguridad <https://www.kaspersky.es/resource-center/threats/what-is-a-security-breach>`__
      Una "brecha de seguridad" se refiere a una situación en la que se
   ...
   `DNS poisoning <https://es.wikipedia.org/wiki/Envenenamiento_de_DNS>`__
      El "DNS poisoning" es un tipo de ataque cibernético que tiene como
   ...
   `DoS (Ataque de Denegación de Servicio) <https://es.wikipedia.org/wiki/Ataque_de_denegaci%C3%B3n_de_servicio>`__
      El "DoS" o Ataque de Denegación de Servicio es una táctica utilizada
      por ciberdelincuentes para inundar un sistema informático o red con
      un flujo abrumador de tráfico de datos, con el objetivo de
      sobrecargar los recursos del sistema y hacer que el servicio o la
      página web se vuelva inaccesible para los usuarios legítimos.
   ...
   `Filtración de datos <https://es.wikipedia.org/wiki/Violaci%C3%B3n_de_datos>`__
      La "filtración de datos" ocurre cuando información confidencial o
   ...
   `Hijacking <https://es.wikipedia.org/wiki/Hijacking>`__
      "Hijacking" o "Secuestro" es un término utilizado en ciberseguridad
      para describir el acto de tomar el control ilegal de una sesión en
      línea, una cuenta de usuario o incluso un dispositivo, por parte de
      un atacante sin el consentimiento del propietario legítimo.
   ...
   `Malvertising <https://es.wikipedia.org/wiki/Malvertising>`__
      El "malvertising" es una forma de ciberataque en la que los
   ...
   `Password spraying <https://www.welivesecurity.com/la-es/2021/01/19/que-es-ataque-password-spraying/>`__
      El "password spraying" es una técnica utilizada por
   ...
   `Pharming <https://es.wikipedia.org/wiki/Pharming>`__
      El "pharming" es una táctica cibernética utilizada por los
   ...
   `Vulnerabilidad <https://es.wikipedia.org/wiki/Inseguridad_inform%C3%A1tica>`__
      Una "vulnerabilidad" en ciberseguridad se refiere a una debilidad o
