...
var IncorrectResponse = 'Mal, prueba de nuevo';
...
function StartUp(){
	...
	PreloadImages('../imagenes6/120px-Logic-gate-and-iec.png','../imagenes6/120px-Logic-gate-or-iec.png','../imagenes6/120px-Logic-gate-inv-iec.png','../imagenes6/120px-Logic-gate-nand-iec.png','../imagenes6/120px-Logic-gate-nor-iec.png','../imagenes6/120px-Logic-gate-and-us.png','../imagenes6/120px-Logic-gate-or-us.png','../imagenes6/120px-Logic-gate-inv-us.png','../imagenes6/120px-Logic-gate-nand-us.png','../imagenes6/120px-Logic-gate-nor-us.png');
...
F = new Array();
F[0] = new Array();
F[0][0]='<img src="../imagenes6/120px-Logic-gate-and-iec.png" alt="-" title="120px-Logic-gate-and-iec" width="120" height="53"></img>';
F[0][1] = 1;
F[1] = new Array();
F[1][0]='<img src="../imagenes6/120px-Logic-gate-or-iec.png" alt="-" title="120px-Logic-gate-or-iec" width="120" height="53"></img>';
F[1][1] = 2;
F[2] = new Array();
F[2][0]='<img src="../imagenes6/120px-Logic-gate-inv-iec.png" alt="-" title="120px-Logic-gate-inv-iec" width="120" height="53"></img>';
F[2][1] = 3;
F[3] = new Array();
F[3][0]='<img src="../imagenes6/120px-Logic-gate-nand-iec.png" alt="-" title="120px-Logic-gate-nand-iec" width="120" height="53"></img>';
F[3][1] = 4;
F[4] = new Array();
F[4][0]='<img src="../imagenes6/120px-Logic-gate-nor-iec.png" alt="120px-Logic-gate-nor-iec.png" title="120px-Logic-gate-nor-iec" width="120" height="53"></img>';
F[4][1] = 5;


D = new Array();
D[0] = new Array();
D[0][0]='<img src="../imagenes6/120px-Logic-gate-and-us.png" alt="-" title="120px-Logic-gate-and-us" width="120" height="53"></img>';
D[0][1] = 1;
D[0][2] = 0;
D[1] = new Array();
D[1][0]='<img src="../imagenes6/120px-Logic-gate-or-us.png" alt="-" title="120px-Logic-gate-or-us" width="120" height="53"></img>';
D[1][1] = 2;
D[1][2] = 0;
D[2] = new Array();
D[2][0]='<img src="../imagenes6/120px-Logic-gate-inv-us.png" alt="-" title="120px-Logic-gate-inv-us" width="120" height="53"></img>';
D[2][1] = 3;
D[2][2] = 0;
D[3] = new Array();
D[3][0]='<img src="../imagenes6/120px-Logic-gate-nand-us.png" alt="-" title="120px-Logic-gate-nand-us" width="120" height="53"></img>';
D[3][1] = 4;
D[3][2] = 0;
D[4] = new Array();
D[4][0]='<img src="../imagenes6/120px-Logic-gate-nor-us.png" alt="-" title="120px-Logic-gate-nor-us" width="120" height="53"></img>';
D[4][1] = 5;
D[4][2] = 0;
