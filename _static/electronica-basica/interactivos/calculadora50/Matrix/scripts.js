...
if (detval==0) { alert("Has entrado en una matriz singular.\r Las matrices singulares no tienen inversas.  \r\rEsto se puede verificar calculando el determinante igual a 0.") }
